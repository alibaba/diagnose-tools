...
#define CMD_PUPIL_TASK_TGID (CMD_PUPIL_TASK_PID + 1)
#define DIAG_IOCTL_PUPIL_TASK_DUMP _IOWR(DIAG_IOCTL_TYPE_PUPIL_TASK, CMD_PUPIL_TASK_DUMP, struct diag_ioctl_dump_param)
#define DIAG_IOCTL_PUPIL_TASK_PID _IOWR(DIAG_IOCTL_TYPE_PUPIL_TASK, CMD_PUPIL_TASK_PID, int)
#define DIAG_IOCTL_PUPIL_TASK_TGID _IOWR(DIAG_IOCTL_TYPE_PUPIL_TASK, CMD_PUPIL_TASK_TGID, int)
